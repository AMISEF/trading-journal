/**
 * Theme helpers — seven selectable themes based on the Crypto Smart palette.
 *
 *   light       — روشن          #F3F6F9  (Very Light Background)
 *   soft        — روشن ملایم    #BFC7CE  (Base Gray)
 *   barbie      — باربی گرل     #FFE4F1  (shades of pink)
 *   cinderella  — سیندرلا       #EEE6FF  (shades of purple)
 *   dark        — دارک           #2B3136  (Gray 900)
 *   ocean       — دارک اوشن     #162F55  (Dark 900 — Deep Background)
 *   classic     — تم کلاسیک     #0A1622  (original dark palette, DEFAULT)
 *
...
export const THEMES: ThemeOption[] = [
  ...
  { id: "barbie", label: "باربی گرل", swatch: "#FF8FC4", swatchOn: "#5C0F36", isDark: false },
  { id: "cinderella", label: "سیندرلا", swatch: "#B18CFF", swatchOn: "#2E1065", isDark: false },
 ...
 * Legacy value: "blue" was a short-lived Blue Dark theme that the classic
 * palette replaced.
 */
