...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "بدون کارت بانکی، بدون تاریخ انقضا — همیشه رایگان",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "اتصال مستقیم به صرافی توبیت: معاملات فیوچرزت خودکار ژورنال می‌شوند — صفر ثبت دستی",
      "خروجی PDF نهادی برای ارائه به سرمایه‌گذار و پراپ‌فرم",
      "همهٔ امکانات پلن طلایی",
    ],
    highlights: [
      "همه‌چیز نامحدود",
