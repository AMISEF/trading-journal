...
قواعدِ مسابقه
-------------
* **هر کسی که حساب دارد عضوِ لیگ است — بدون استثنا.** حتی اگر در این دوره
  هیچ معامله‌ای نبسته باشد، ردیفش در جدول می‌آید (در انتهای فهرست، با
  وضعیتِ «بدون معامله در این دوره») تا هیچ‌کس از لیگ غیب نشود. حسابِ
...
async def leaderboard(
    ...
    *,
    ...
    فهرست بدون هیچ استثنایی شامل همهٔ کاربران است — حتی آن‌ها که در این دوره
    معامله‌ای نبسته‌اند و حتی حسابِ نمایشی/دموی سایت — و صفحه‌بندی در لایهٔ
    API انجام می‌شود.
    """
